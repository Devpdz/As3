package DpdzUtils.tfm
{
    ...
    public class Label extends Component
    {
        ...
        override protected function addChildren() : void
        {
            ...
            var _loc_1:* = new TextFormat(Style.x_policeInterface, Style.fontSize, this._fontColor == -1 ? (Style.COULEUR_TEXTE_DEFAUT) : (this._fontColor));
            _loc_1.align = this._align;
            this._tf.defaultTextFormat = _loc_1;
            if (this._html)
            {
