package DpdzUtils.tfm
{
    ...
    public class Style extends Object
    {
        ...
        public static var FOND_TITRE_FENETRE:int = 1380887;
        ...
        private static function lumiereSouris1(event:MouseEvent) : void
        {
            var _loc_2:* = event.currentTarget as Sprite;
            _loc_2.transform.colorTransform = couleurLumiere;
            return;
        }// end function

        private static function lumiereSouris2(event:MouseEvent) : void
        {
            var _loc_2:* = event.currentTarget as Sprite;
            _loc_2.transform.colorTransform = couleurNormal;
            return;
        }// end function
